...
/***/ function(module, exports, __webpack_require__) {
	...
	var _core = __webpack_require__(/*! @cycle/core */ 1);
	...
	function main(sources) {
	  var decrementClicks$ = sources.DOM.select('.decrement').events('click');
	  var incrementClicks$ = sources.DOM.select('.increment').events('click');
	  var decrementAction$ = decrementClicks$.map(function (ev) {
	    return -1;
	  });
	  var incrementAction$ = incrementClicks$.map(function (ev) {
	    return +1;
	  });
	  var number$ = _rx2.default.Observable.merge(decrementAction$, incrementAction$).startWith(0).scan(function (acc, cur) {
	    return acc + cur;
	  });
	
	  var sinks = {
	    DOM: number$.map(function (number) {
	      return (0, _dom.div)([(0, _dom.button)('.decrement', 'Decrement'), (0, _dom.button)('.increment', 'Increment'), (0, _dom.p)([(0, _dom.label)(String(number))])]);
	    })
	  };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var svg = __webpack_require__(/*! ./virtual-hyperscript-svg */ 7);
	
	var _require = __webpack_require__(/*! ./render-dom */ 27);
	
	var makeDOMDriver = _require.makeDOMDriver;
	
	var _require2 = __webpack_require__(/*! ./render-html */ 49);
